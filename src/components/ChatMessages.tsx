// ===================================
// CONSOLIDATED CHAT MESSAGES COMPONENTS
// Merges: MessagesList + MessageBubble
// ===================================
...
// ============ MESSAGE BUBBLE (from MessageBubble.tsx) ============
...
export const MessageBubble = ({ message, lang, onButtonClick, showButtons = true }: MessageBubbleProps) => {
  ...
  if (!message.isUser && 
    ...
    !message.meta?.bookingSummary &&
    !message.meta?.contactInfo &&
        ...
        >
          {message.meta?.card?.type === 'trip' ? (
            ...
            <div className="space-y-2">
              ...
              {message.meta?.bookingSummary ? (
                <BookingSummaryWidget
                  title_ar={message.meta.bookingSummary.title_ar}
                  title_en={message.meta.bookingSummary.title_en}
                  data={message.meta.bookingSummary.data}
                  actions={message.meta.bookingSummary.actions}
                  lang={lang}
                  onActionClick={(value, text) =>
                    onButtonClick && onButtonClick({
                      text: text,
                      value: value
                    })
              ...
              {message.meta?.contactInfo ? (
                <ContactInfoWidget
                  title_ar={message.meta.contactInfo.title_ar}
                  title_en={message.meta.contactInfo.title_en}
                  lang={lang}
                  onSubmit={(data) =>
                    onButtonClick && onButtonClick({
                      text: `${data.name} - ${data.phone}`,
                      value: `contact_info:${data.name}|${data.phone}|${data.email}`
                    })
                  }
                />
              ) : null}
...
// ============ MESSAGES LIST (from MessagesList.tsx) ============
