...
// Copied from @shared/types to make package standalone
// ===================================
...
export type UIBlock =
  ...
  | { type: 'destinations'; title?: string; categories?: DestinationCategory[] }
  | { type: 'budget'; title_ar?: string; title_en?: string; ranges: BudgetRange[] }
  | { type: 'hotelCards'; hotels: HotelCard[] }
  | { type: 'quickReplies'; title_ar?: string; title_en?: string; options: QuickReply[] }
  | { type: 'hotelFilters'; title_ar?: string; title_en?: string; filters: HotelFilters }
  | { type: 'mealPlans'; title_ar?: string; title_en?: string; options: MealPlan[] }
  | { type: 'roomTypes'; title_ar?: string; title_en?: string; options: RoomType[] }
  | { type: 'bookingSummary'; title_ar?: string; title_en?: string; data: BookingSummaryData; actions?: BookingAction[] }
