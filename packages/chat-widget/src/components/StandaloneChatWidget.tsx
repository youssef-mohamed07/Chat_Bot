...
// export default function Page() { return <StandaloneChatWidget apiBaseURL="https://your-api.com" /> }

export interface StandaloneChatWidgetProps {
 apiBaseURL: string
 initialOpen?: boolean
}

export default function StandaloneChatWidget({ apiBaseURL, initialOpen = false }: StandaloneChatWidgetProps) {
